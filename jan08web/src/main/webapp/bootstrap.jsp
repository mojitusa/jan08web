...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <div class="mt-5">
        	...
        	<div class="m-2 p-5 border-top border-bottom">
        	<table class="table table-hover">
        		...
        		<tbody>
        			<c:forEach items="${list }" var="row">
        				<tr class="row">
        					<th class="col-1">${row.no }</th>
        					<th class="col-6">${row.title }</th>
        					<th class="col-2">${row.write }</th>
        					<th class="col-1">${row.date }</th>
        					<th class="col-1">${row.count}</th>
        				<tr>
        			</c:forEach>
        		</tbody>
        	</table>
        	...
        	<div class="container bg-info text-white">
        		...
        		<div class="mx-2 my-5 bg-secondary">구역3</div>
